    ...
    <div style={{ width: "100%", padding: "100px", alignContent: "center" }}>
      <header>
        ...
        <h4>
          ...
          <h3>Your pages:</h3>
          <ul>
            <li><Link href="/products">Homepage - /products</Link></li>
<li><Link href="/auth">Auth - /auth</Link></li>
<li><Link href="/protected">Protected - /protected</Link></li>
<li><Link href="/ssr">Ssr - /ssr</Link></li>
          </ul>
