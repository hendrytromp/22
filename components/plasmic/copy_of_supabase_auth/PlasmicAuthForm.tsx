      ...
      >
        {(() => {
          ...
          return (
            ...
            >
              <FormItemWrapper
                className={classNames("__wab_instance", sty.formField__v7Vi)}
                label={"Email"}
                name={"email"}
              >
                <AntdInput
              ...
              <FormItemWrapper
                className={classNames("__wab_instance", sty.formField__r6Aql)}
                label={"Password"}
                name={"password"}
              >
                <AntdPassword
              ...
              >
                <div
                  className={classNames(
                    ...
                    sty.text__sFkaA,
                    {
                      [sty.textmode_signUp__sFkaAbkKf]: hasVariant(
                        $state,
                        "mode",
                        "signUp"
                      )
