      ...
      >
        {(() => {
          ...
          return (
            ...
            >
              <FormItemWrapper
                className={classNames("__wab_instance", sty.formField__xod3D)}
                label={"Email"}
                name={"email"}
              >
                <AntdInput
              ...
              <FormItemWrapper
                className={classNames("__wab_instance", sty.formField__wb93C)}
                label={"Password"}
                name={"password"}
              >
                <AntdPassword
              ...
              >
                <div
                  className={classNames(
                    ...
                    sty.text__cbb0V,
                    {
                      [sty.textmode_signUp__cbb0VbkKf]: hasVariant(
                        $state,
                        "mode",
                        "signUp"
                      )
