...
import sty from "./PlasmicAuthButton.module.css"; // plasmic-import: 9IgivLkzm2sZ/css
...
export type PlasmicAuthButton__OverridesType = {
  root?: Flex__<"div">;
  logoutBtn?: Flex__<typeof AntdButton>;
    ...
    >
      {(() => {
        ...
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__kgroV)}
        >
          <div
            className={classNames(
              projectcss.all,
      ...
      {(() => {
        ...
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__mnfde)}
        >
          <AntdButton
            ...
            onClick={async () => {
              ...
              $steps["goToAuth"] = true
                ? (() => {
                    const actionArgs = { destination: `/auth` };
                    return (({ destination }) => {
                      if (
